...
|-------|----------|---------------|
| **[Brainstorming](brainstorming.md)** | design | Refine rough ideas into validated designs |
...
1. Choose appropriate category (design/, coding/, collaboration/, analysis/, automation/, documents/, writing/, meta/)
